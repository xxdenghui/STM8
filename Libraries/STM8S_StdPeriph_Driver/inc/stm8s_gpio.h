...
void GPIO_PinSet( GPIO_TypeDef* GPIOx, uint8_t PortPins, BitStatus bits );
void GPIO_WriteHigh(GPIO_TypeDef* GPIOx, uint8_t PortPins);
void GPIO_WriteLow(GPIO_TypeDef* GPIOx, uint8_t PortPins);
void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, uint8_t PortPins);
uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx);
uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx);
BitStatus GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, uint8_t GPIO_Pin);
